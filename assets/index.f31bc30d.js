...
`,Ee=`import { defineConfig } from 'vite'
...
`;const Be=(s="")=>{let e={[I]:new f(I,Te,!0),[g]:new f(g,T)};if(s)try{e={};const t=JSON.parse(ye(s));for(const n of Object.keys(t)){const i=n===I;e[n]=new f(n,t[n],i)}}catch(t){console.log(t)}return e},He=s=>{const e=j("@vue/compiler-sfc",s,"/dist/compiler-sfc.esm-browser.js"),t=j("@vue/runtime-dom",s,"/dist/runtime-dom.esm-browser.js");return{compilerSfc:e,runtimeDom:t}},Ge=s=>{const e=d({},Ue(s));return d(d({},Object.fromEntries(Object.entries(e).map(([t,n])=>[t,j(n.pkg,n.version,n.file)]))),Object.fromEntries(Object.entries(d({},Je())).map(([t,n])=>[t,n.file])))};class Xe{constructor({serializedState:e="",versions:t={Vue:"latest",iDux:"latest"}}){m(this,"state");m(this,"compiler",le);m(this,"options");m(this,"versions");m(this,"initialShowOutput",!1);m(this,"initialOutputMode","preview");m(this,"pendingCompiler",null);const n=Be(e),i=n[I]?I:Object.keys(n)[0];this.state=A({mainFile:i,files:n,activeFile:n[g],errors:[],vueRuntimeURL:""}),this.versions=t,this.initImportMap()}initImportMap(){this.state.files["import-map.json"]||(this.state.files["import-map.json"]=new f("import-map.json",JSON.stringify({imports:{}},null,2)))}getImportMap(){try{return JSON.parse(this.state.files["import-map.json"].code)}catch(e){return this.state.errors=[`Syntax error in import-map.json: ${e.message}`],{}}}setImportMap(e){try{this.state.files["import-map.json"].code=JSON.stringify(e,null,2)}catch(t){this.state.errors=[`stringify error in import-map.json: ${t.message}`]}}addDeps(){const e=this.getImportMap();e.imports=d(d({},e.imports),Ge(this.versions)),this.setImportMap(e)}async setVersion(e,t){switch(e){case"iDux":await this.setIduxVersion(t),y(this,this.state.files[k]);break;case"Vue":await this.setVueVersion(t);break}}async setIduxVersion(e){this.versions.iDux=e;const t=j("@idux/components",e,"/default.min.css");this.state.files[k]=new f(k,ze.replace("#STYLE_HREF#",t),!0),this.addDeps()}async setVueVersion(e){const{compilerSfc:t,runtimeDom:n}=He(e);this.pendingCompiler=U(()=>import(t),[]),this.compiler=await this.pendingCompiler,this.pendingCompiler=null,this.state.vueRuntimeURL=n,this.versions.Vue=e,this.addDeps()}async initStore(){await this.setVueVersion(this.versions.Vue),await this.setIduxVersion(this.versions.iDux),F(()=>y(this,this.state.activeFile));for(const e of Object.keys(this.state.files))e!==g&&y(this,this.state.files[e])}setActive(e){this.state.activeFile=this.state.files[e]}addFile(e){const t=typeof e=="string"?new f(e):e;this.state.files[t.filename]=t,t.hidden||this.setActive(t.filename)}deleteFile(e){(window==null?void 0:window.confirm(`Confirm to delete ${e}?`))&&(this.state.activeFile.filename===e&&(this.state.activeFile=this.state.files[g]),delete this.state.files[e])}getFiles(){const e={};for(const t of Object.keys(this.state.files))e[t]=this.state.files[t].code;return e}async setFiles(e,t=g){const n={};t===g&&!e[t]&&(n[t]=new f(t,T));for(const[i,o]of Object.entries(e))n[i]=new f(i,o);for(const i of Object.values(n))await y(this,i);this.state.mainFile=t,this.state.files=n,this.initImportMap(),this.setActive(t)}serialize(){const e=Object.entries(this.getFiles()).filter(([n])=>n!==k&&n!=="import-map.json").map(([n,i])=>{if(n==="import-map.json")try{const o=JSON.stringify(this.getImportMap(),null,2);return[n,o]}catch{}return[n,i]}),t=JSON.stringify(Object.fromEntries(e));return`#${_e(t)}`}}var qe=(s,e)=>{const t=s.__vccOpts||s;for(const[n,i]of e)t[n]=i;return t};const Ye=s=>(fe("data-v-e2dcf550"),s=s(),ve(),s),Ze=Ye(()=>w("div",{class:"ixp-height-full"},null,-1)),Ke={class:"flex flex-col ixp-height-full"},We=P({setup(s){const e=pe(!0),t=new Xe({serializedState:location.hash.slice(1)});return t.initStore().then(()=>{e.value=!1}),F(()=>history.replaceState({},"",t.serialize())),(n,i)=>{const o=$,r=Fe,a=ue;return h(),_(a,null,{default:l(()=>[e.value?(h(),_(o,{key:0,tip:"loading..."},{default:l(()=>[Ze]),_:1})):de("",!0),w("div",Ke,[p(r,{store:x(t)},null,8,["store"]),p(x(me),{class:"grow","auto-resize":"","show-compile-output":"",store:x(t),"clear-console":!1},null,8,["store"])])]),_:1})}}});var Qe=qe(We,[["__scopeId","data-v-e2dcf550"]]);he(ge);xe(Qe).mount("#app");
