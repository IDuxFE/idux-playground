var D=Object.defineProperty;var N=(o,e,t)=>e in o?D(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var l=(o,e,t)=>(N(o,typeof e!="symbol"?e+"":e,t),t);import{F as R,d as E,u as F,c as O,r as C,I as P,a as B,b as L,o as x,e as V,f as I,t as $,g as m,h as u,w as c,Q as U,i as h,j as M,v as J,k as T,l as z,m as d,n as j,p as _,q,s as G,x as b,y as Q,R as X,z as H,A as Z,B as K,C as W,D as Y}from"./vendor.470e39fc.js";const ee=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerpolicy&&(i.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?i.credentials="include":n.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}};ee();const te=o=>btoa(unescape(encodeURIComponent(o))),ne=o=>decodeURIComponent(escape(atob(o))),se="modulepreload",S={},oe="./",ie=function(e,t){return!t||t.length===0?e():Promise.all(t.map(s=>{if(s=`${oe}${s}`,s in S)return;S[s]=!0;const n=s.endsWith(".css"),i=n?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${i}`))return;const r=document.createElement("link");if(r.rel=n?"stylesheet":se,n||(r.as="script",r.crossOrigin=""),r.href=s,document.head.appendChild(r),n)return new Promise((a,f)=>{r.addEventListener("load",a),r.addEventListener("error",f)})})).then(()=>e())};var re=`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
pnpm run dev
\`\`\`
`;const pe=async o=>{const e=["setupIdux.js","import-map.json"],{default:t}=await ie(()=>import("./jszip.min.334cc910.js").then(function(a){return a.j}),["assets/jszip.min.334cc910.js","assets/vendor.470e39fc.js"]),s=new t;s.file("index.html",re),s.file("package.json",ce),s.file("vite.config.js",le),s.file("README.md",de);const n=s.folder("src");n==null||n.file("main.js",ae),n==null||n.file("idux.js",ue);const i=o.getFiles();for(const a in i){if(e.includes(a))continue;let f=i[a];a==="App.vue"&&(f=f.replace(`import { setupIdux } from './setupIdux.js'
`,"").replace(`setupIdux() // don't remove
`,"")),n==null||n.file(a,f)}const r=await s.generateAsync({type:"blob"});R.exports.saveAs(r,"idux-starter.zip")},fe={class:"flex justify-between p-2"},me={class:"text-base"},ve=h(" Download "),he=h(" QRCode "),xe=h(" Share "),Ie=h(" GitHub "),_e=E({props:{store:null},setup(o){const e=o,{success:t,warning:s}=F(),n=async()=>{if(!navigator.clipboard){s("navigator.clipboard is undefined");return}await navigator.clipboard.writeText(location.href),t("Current URL has been copied to clipboard.")},i=O(()=>` ( Vue@${e.store.versions.Vue}, Idux@${e.store.versions.Idux} )`),r=C(""),a=()=>{r.value=location.href};return(f,y)=>{const v=P,k=B,A=L;return x(),V("div",fe,[I("h1",me," Idux Playground "+$(m(i)),1),u(A,null,{default:c(()=>[u(v,{onClick:y[0]||(y[0]=Ae=>m(pe)(o.store))},{default:c(()=>[ve]),_:1}),u(k,null,{content:c(()=>[u(U,{value:r.value,size:500},null,8,["value"])]),default:c(()=>[u(v,{onMouseenter:a},{default:c(()=>[he]),_:1})]),_:1}),u(v,{onClick:n},{default:c(()=>[xe]),_:1}),u(v,{mode:"link",href:"https://github.com/brenner8023/idux-playground",target:"_blank",rel:"noopener noreferrer"},{default:c(()=>[Ie]),_:1})]),_:1})])}}}),g="setupIdux.js",ge=`
